"
" This is the syntax/sh.vim file of vim 9.1 which highlights heredocs
" correctly (so very important for catching errors when doing intented
" heredocs.  Using just the heredoc part does something to herestrings
" so might as well use the whole file.
"
" Vim syntax file
