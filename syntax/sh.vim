" Copied from the regular runtime/syntax/sh.vim with the only change being
" commenting out the line marked '" PHIL' below to prevent the word `print`
" from being colored like a keyword/builtin (echo, printf, for, if, while,
" cd ...).
"
" Vim syntax file
...
if (exists("b:is_kornshell") && !exists("b:is_ksh88"))
    ...
    " PHIL: This is responsible for making `print` look like it's a valid
    " keyword when it is in fact not.
